...
class TrainsControllerTest < ActionController::TestCase
  ...
  test "should create train" do
    assert_difference('Train.count') do
      post :create, train: { description: @train.description, image: @train.image, name: @train.name, video: @train.video }
    end
  ...
  test "should update train" do
    patch :update, id: @train, train: { description: @train.description, image: @train.image, name: @train.name, video: @train.video }
    assert_redirected_to train_path(assigns(:train))
  end
